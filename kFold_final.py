...
for train, test in kf.split(X):
    ...
    #feature cut
	train_features = SelectKBest(fs.f_classif, k=99).fit_transform(train_features, train_output)
    ...
    #feature cut
	test_features = SelectKBest(fs.f_classif, k=99).fit_transform(test_features, test_output)
